#!/usr/bin/env python
"""
Start PanoRAG server with Gunicorn
"""
...
from panorag.api.utils_api import display_splash_screen, check_env_file
from panorag.kg.shared_storage import initialize_share_data, finalize_share_data
...
def main():
    ...
    print("🚀 Starting PanoRAG with Gunicorn")
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from panorag.api import gunicorn_config
        ...
        def load(self):
            ...
            from panorag.api.panorag_server import get_application
