"""
Utility functions for the PanoRAG API.
"""
...
from panorag.api import __api_version__ as api_version
from panorag import __version__ as core_version
...
def get_combined_auth_dependency(api_key: Optional[str] = "sk-q29RK5VskYe2SuulvdmZtJ0YMnFShm8KJGf7gVnoniZQ2598"):
    """
...
def display_splash_screen(args: argparse.Namespace) -> None:
    """
    Display a colorful splash screen showing PanoRAG server configuration
    ...
    ASCIIColors.cyan(f"""
    ╔══════════════════════════════════════════════════════════════╗
    ║                  🚀 PanoRAG Server v{core_version}/{api_version}              ║
