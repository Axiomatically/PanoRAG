...
@dataclass
class PanoRAG:
    """PanoRAG: Enabling Consistent Global Topic Awareness in Graph-Based RAG."""

    # Directory
    # ---

    working_dir: str = field(
        default=f"./panorag_cache_{datetime.now().strftime('%Y-%m-%d-%H:%M:%S')}"
    )
    ...
    """If True, panorag will automatically calls initialize_storages and finalize_storages at the appropriate times."""
    ...
    def __post_init__(self):
        ...
        logger.debug(f"PanoRAG init with param:\n  {_print_config}\n")
