...
from panorag.utils import logger, compute_mdhash_id
from panorag.base import BaseVectorStorage
...
class FaissVectorDBStorage(BaseVectorStorage):
    """
    A Faiss-based Vector DB Storage for PanoRAG.
    ...
    def client_storage(self):
        # Return whatever structure PanoRAG might need for debugging
