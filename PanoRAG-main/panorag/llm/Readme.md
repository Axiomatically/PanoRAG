...
1. **LlamaIndex** (`llm/llama_index.py`):
   ...
   - See example implementations:
     - [Direct OpenAI Usage](../../examples/panorag_llamaindex_direct_demo.py)
     - [LiteLLM Proxy Usage](../../examples/panorag_llamaindex_litellm_demo.py)

<details>
<summary> <b>Using LlamaIndex</b> </summary>

PanoRAG supports LlamaIndex for embeddings and completions in two ways: direct OpenAI usage or through LiteLLM proxy.
...
from panorag.llm.llama_index_impl import llama_index_complete_if_cache, llama_index_embed
...
# Initialize PanoRAG with OpenAI
rag = PanoRAG(
...
# Initialize PanoRAG with LiteLLM
rag = PanoRAG(
    working_dir="your/path",
    llm_model_func=llm_model_func,
    embedding_func=EmbeddingFunc(
